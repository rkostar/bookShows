...
public class Main {
    public static void main(String[] args) {
        ...
        show.showsPresent();    // will update the shows and call updateShows()
        // System.out.println(totalShows);
        boolean accountflag=false;  // used to check id account is created or not
        boolean flag=true;
        while (flag) {
            ...
            switch (n) {
                case 1:
                    ...
                    accountflag= p1.checkIfCreated();       // if account is created or not
                    System.out.println();
                    break;
                ...
                case 2:
                    ...
                    show.getDetails();      //will call showMovie()
...
class shows {
    ...
    boolean ifShowing(String movie){
        return us.ifMovieExists(movie);
    }
}